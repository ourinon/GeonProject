...
export default function DtlPage() {
    ...
    const productSeqId = 1;

    useEffect(() => {
        axios
            .get(`http://localhost:4080/api/auth/dtlPage/${productSeqId}`)
            .then((response) => {
                ...
                if (!result) alert(data.message);
                    ...
                    setProductLike(data.data.productLike);
            ...
            <Box display={"flex"} justifyContent={"center"}>
                ...
                <Box border={1}>
                    <Box borderBottom={1} padding={1}>
                        ...
                        <Typography>{productWriter}</Typography>
                        <Typography>{productPublicationDate}</Typography>
                        <Typography>{productPublisher}</Typography>
                    </Box>
                    <Box
                        display={"flex"}
                    ...
                    >
                        <Box>
                            ...
                            <Typography>{productSalesPrice}</Typography>
                        </Box>
                    </Box>
                    <Box
                        display={"flex"}
                    ...
                    >
                        <Box>
                            <Typography>배송비/배송정보</Typography>
                        </Box>
                        <Box>
                            <Typography>3000원</Typography>
                        </Box>
                    </Box>
                    <Box
                        display={"flex"}
